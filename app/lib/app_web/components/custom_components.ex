...
def sidebar(assigns) do
  ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
      ...
      <symbol id="student" viewBox="0 0 16 16">
      ...
      <symbol id="rewards" viewBox="0 0 16 16">
    ...
    <div class="d-flex flex-column flex-shrink-0 text-bg-dark" style="width: 4.5rem;">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-start">
          <li class="nav-item">
            <%= if @active_tab == "class" do %>
              <a href={~p"/"} class="nav-link active py-3 border-bottom rounded-0" aria-current="page" title="Class" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none d-block mx-auto" width="24" height="24" role="img" aria-label="Class"><use xlink:href="#student"/></svg>
              </a>
            <% else %>
          ...
          <li>
            <%= if @active_tab == "rewards" do %>
              <a href={~p"/shop"} class="nav-link active py-3 border-bottom rounded-0" title="Rewards" data-bs-toggle="tooltip" data-bs-placement="right">
          ...
          <li>
            <%= if @active_tab == "settings" do %>
              <a href={~p"/users/settings"} class="nav-link active py-3 border-bottom rounded-0" title="Settings" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none d-block mx-auto" width="24" height="24" role="img" aria-label="Settings"><use xlink:href="#settings"/></svg>
              </a>
            <% else %>
              <a href={~p"/users/settings"} class="nav-link py-3 border-bottom rounded-0" title="Settings" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none d-block mx-auto" width="24" height="24" role="img" aria-label="Settings"><use xlink:href="#settings"/></svg>
              </a>
            <% end %>
          </li>
        ...
        <div class="border-top text-start">
          <!--
          <a class="d-flex align-items-center justify-content-center p-3 link-body-emphasis text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="https://avatars.githubusercontent.com/u/9919?v=4" alt="avatar" width="24" height="24" class="rounded-circle">
          </a>
          <ul class="dropdown-menu text-small shadow">
            <li><a class="dropdown-item" href={~p"/users/settings"}>Settings</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><.link class="dropdown-item" href={~p"/users/log_out"} method="delete">Sign out</.link></li>
          </ul>
          -->
          <.link href={~p"/users/log_out"} class="d-flex align-items-center justify-content-center p-3 text-decoration-none rounded-0" method="delete" data-bs-placement="right">
            <svg class="bi pe-none d-block mx-auto" width="24" height="24" role="img" aria-label="Class"><use xlink:href="#exit"/></svg>
          </.link>
        </div>
    </div>
  """
